      ...
      <Card className="card-financial">
        ...
        <CardContent>
          <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            {balance <= 0 && (
              <p className="text-sm text-red-600 mt-2">⚠️ تحتاج لتحسين ميزانيتك قبل وضع أهداف ادخار جديدة</p>
            )}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {goals.map((goal) => {
              ...
              return (
                <Card key={goal.id} className="p-6 border-2 border-gray-100 hover:border-primary/30 transition-colors">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm text-gray-600">
                      ...
                      <span>
                        {balance > 0 
                          ? `${monthsToGoal} شهر متبقي` 
                          : 'يحتاج تحسين الميزانية'
                        }
                      </span>
                    </div>
                  </div>
